...
sidebar:
  order: 8
description: Use Cloudflare Workflows with Agents for durable, multi-step background processing while Agents handle real-time communication
---
...
- Basic familiarity with [Cloudflare Agents](/agents/)
- Basic familiarity with [Cloudflare Workflows](/workflows/)
...
Configure your Durable Objects and Workflows bindings:
