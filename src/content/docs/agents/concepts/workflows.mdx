...
:::note[Cloudflare Workflows Integration]

This page explains the conceptual role of workflows in agent architecture. For information on integrating Agents with [Cloudflare Workflows](/workflows/) (the product) for durable execution, automatic retries, and long-running tasks, refer to the [Cloudflare Workflows Integration Guide](/agents/guides/cloudflare-workflows/).
